...
public class Main extends JavaPlugin {
        ...
        public void onEnable() {
                ...
                ConnectionEstablisher connectionEstablisher = new ConnectionEstablisher(this, getLogger(), playerLogger,
                                modSyncLogger, dataManager);

                // Register events
                getServer().getPluginManager().registerEvents(
                                new JoinListener(this, connectionEstablisher, modSyncLogger, dataManager),
                                this);

                // Register commands
                getCommand("modsync").setExecutor(
                                new ModSyncCommand(this, connectionEstablisher, dataManager, modSyncLogger));
